...
def main() -> None:
    ...
    meta: dict[str, Any] = {
        ...
        "debug": {
            ...
            "fixed_output_vs_hf_max_abs_diff": float(np.max(np.abs(diff))),
            "fixed_output_vs_hf_mean_abs_diff": float(np.mean(np.abs(diff))),
        },
    ...
    print(
        ...
        f"max={meta['debug']['fixed_output_vs_hf_max_abs_diff']:.8g} "
        f"mean={meta['debug']['fixed_output_vs_hf_mean_abs_diff']:.8g}"
    )
