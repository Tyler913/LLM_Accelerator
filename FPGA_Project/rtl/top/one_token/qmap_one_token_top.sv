...
(
    ...
    qmap_one_token_layer_scheduler #(
        ...
        .USE_RUNTIME_BASE_ADDR_PORTS(USE_RUNTIME_BASE_ADDR_PORTS)
    ) scheduler (
        .i_clk(i_clk),
        .i_rst_n(i_rst_n),
        ...
        .i_runtime_context_enable(i_runtime_context_enable),
        ...
        .i_qkv_qmap_base_addr(i_qkv_qmap_base_addr),
        .i_input_norm_qmap_base_addr(i_input_norm_qmap_base_addr),
        ...
        .i_runtime_base_addr_valid(i_runtime_base_addr_valid),
        .i_runtime_base_addr_layer(i_runtime_base_addr_layer),
    ...
    qmap_final_token_tail_compute_path #(
        ...
        .ROW_PARALLEL   (TAIL_ROW_PARALLEL),
        .INPUT_SIZE     (INPUT_SIZE),
        .GROUP_SIZE     (GROUP_SIZE),
        .GROUP_COUNT    (GROUP_COUNT),
        .GROUP_PARALLEL (GROUP_PARALLEL),
