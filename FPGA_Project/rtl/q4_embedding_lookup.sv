...
module q4_embedding_lookup #(
    ...
    logic [INPUT_SIZE*WEIGHT_WIDTH-1 : 0] weight_flat;
    ...
    always_comb begin
        current_weight = weight_flat[output_index*WEIGHT_WIDTH +: WEIGHT_WIDTH];
            ...
            case (state)
                ...
                S_WEIGHT_READ: begin
                    if (i_mem_rd_rsp_valid) begin
                        ...
                        weight_flat[read_word_index*MEM_DATA_WIDTH +: MEM_DATA_WIDTH] <= i_mem_rd_rsp_data;
