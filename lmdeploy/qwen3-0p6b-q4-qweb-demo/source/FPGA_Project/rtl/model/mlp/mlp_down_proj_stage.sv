...
//
//   mlp_hidden[3072] -> down_proj[1024]
//
// The local stage reuses the parameterized Q4 GEMV projection controller with
// INPUT_SIZE=3072 and OUT_FEATURES=1024. The projection core produces Q26 row
// sums; this wrapper converts each row to signed Q12.12 and emits an output
// ready/valid stream.
module mlp_down_proj_stage #(
